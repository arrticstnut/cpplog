...
namespace cc
{
	...
	//带位置参数的log接口
	#define logErrorLoc(msg) logError(prefix(msg))
	#define logWarnLoc(msg) logWarn(prefix(msg))
	#define logInfoLoc(msg) logInfo(prefix(msg))
	#define logDebugLoc(msg) logDebug(prefix(msg))
